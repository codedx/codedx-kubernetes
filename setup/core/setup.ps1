...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2024.6.2',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2024.6.2',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2024.6.2',
	...
	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-tomcat:v2024.6.2',
	[string]                 $imageMariaDB            = 'codedx/codedx-mariadb:v1.32.0',
	...
	[string]                 $codedxGitRepoBranch = 'charts-2.74.0',
