...
Here are the deployment steps required to use [Code Dx with LDAP](https://documentation.blackduck.com/bundle/srm/page/install_guide/SRMConfiguration/active-directory-props.html):
