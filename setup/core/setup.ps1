...
param (
	...
	[string]                 $imageCodeDxTomcat     = 'codedx/codedx-tomcat:v5.2.11',
	[string]                 $imageCodeDxTools      = 'codedx/codedx-tools:v5.2.11',
	[string]                 $imageCodeDxToolsMono  = 'codedx/codedx-toolsmono:v5.2.11',
	...
	[string]                 $codedxGitRepoBranch = 'v1.7.0',
