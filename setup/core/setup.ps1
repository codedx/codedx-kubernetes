...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2024.9.6',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2024.9.6',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2024.9.6',
	...
	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-tomcat:v2024.9.6',
