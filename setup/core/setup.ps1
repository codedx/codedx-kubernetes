...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2022.1.1',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2022.1.1',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2022.1.1',

	[string]                 $imagePrepare            = 'codedx/codedx-prepare:v1.13.0',
	[string]                 $imageNewAnalysis        = 'codedx/codedx-newanalysis:v1.13.0',
	[string]                 $imageSendResults        = 'codedx/codedx-results:v1.13.0',
	[string]                 $imageSendErrorResults   = 'codedx/codedx-error-results:v1.13.0',
	[string]                 $imageToolService        = 'codedx/codedx-tool-service:v1.13.0',
	[string]                 $imagePreDelete          = 'codedx/codedx-cleanup:v1.13.0',

	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-bash:v1.3.0',
	[string]                 $imageMariaDB            = 'codedx/codedx-mariadb:v1.4.0',
	[string]                 $imageMinio              = 'bitnami/minio:2021.4.6-debian-10-r11',
	[string]                 $imageWorkflowController = 'codedx/codedx-workflow-controller:v2.15.0',
	[string]                 $imageWorkflowExecutor   = 'codedx/codedx-argoexec:v2.15.0',
