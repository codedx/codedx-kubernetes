...
param (
	...
	[string] $deploymentCodeDx = 'codedx-app-codedx',
	[string] $statefulSetMariaDBMaster = 'codedx-app-mariadb-master',
	[string] $statefulSetMariaDBSlave = 'codedx-app-mariadb-slave',
	[int]    $statefulSetMariaDBSlaveCount = 1,
	[string] $mariaDbSecretName = 'codedx-app-mariadb',
	[string] $mariaDbMasterServiceName = 'codedx-app-mariadb',
	[string] $rootPwd = '',
	[int]    $waitSeconds = 600
)
