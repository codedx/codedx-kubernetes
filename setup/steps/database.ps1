...
https://github.com/codedx/codedx-kubernetes/blob/feature/guide/setup/core/docs/db/use-rds-for-code-dx-database.md

Once you have a database server, follow these instructions to create your Code Dx database:
https://github.com/codedx/codedx-kubernetes/blob/feature/guide/setup/core/docs/db/use-external-database.md
'@
