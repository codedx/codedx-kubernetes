...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2023.1.0',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2023.1.0',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2023.1.0',

	[string]                 $imagePrepare            = 'codedx/codedx-prepare:v1.19.0',
	[string]                 $imageNewAnalysis        = 'codedx/codedx-newanalysis:v1.19.0',
	[string]                 $imageSendResults        = 'codedx/codedx-results:v1.19.0',
	[string]                 $imageSendErrorResults   = 'codedx/codedx-error-results:v1.19.0',
	[string]                 $imageToolService        = 'codedx/codedx-tool-service:v1.19.0',
	[string]                 $imagePreDelete          = 'codedx/codedx-cleanup:v1.19.0',

	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-tomcat:v2023.1.0',
	[string]                 $imageMariaDB            = 'codedx/codedx-mariadb:v1.18.0',
