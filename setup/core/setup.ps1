...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2022.4.6',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2022.4.6',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2022.4.6',
	...
	[string]                 $codedxGitRepoBranch = 'charts-2.3.0',
