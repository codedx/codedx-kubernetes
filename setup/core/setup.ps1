...
param (
	...
	[string]                 $imageCodeDxTomcat       = 'codedx/codedx-tomcat:v2023.8.8',
	[string]                 $imageCodeDxTools        = 'codedx/codedx-tools:v2023.8.8',
	[string]                 $imageCodeDxToolsMono    = 'codedx/codedx-toolsmono:v2023.8.8',
	...
	[string]                 $imageCodeDxTomcatInit   = 'codedx/codedx-tomcat:v2023.8.8',
